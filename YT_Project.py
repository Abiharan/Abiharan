...
client = pymongo.MongoClient("mongodb://AbinayaM:Password123@ac-xolb7gg-shard-00-00.lclmhv8.mongodb.net:27017,ac-xolb7gg-shard-00-01.lclmhv8.mongodb.net:27017,ac-xolb7gg-shard-00-02.lclmhv8.mongodb.net:27017/?ssl=true&replicaSet=atlas-8sy950-shard-0&authSource=admin&retryWrites=true&w=majority")

# Connect to Postgres
data = psycopg2.connect(host='localhost', user='postgres', password='Abinaya@0906', database='YT_db')
cursor = data.cursor()
...
def fetch_channel(youtube,channel_id):
  request = youtube.channels().list(
        part="snippet,contentDetails,statistics", #chnl details, (json format)
        id=channel_id)
...
channel_id = st.text_input("Paste channel id")
...
if frames=='None':
    st.write("Select your requirement")
